...
see [release note](http://github.com/isa-group/governify-csp-tools/releases/tag/0.0.1) for details.

For running:

- Download latest version from [0.0.1](http://github.com/isa-group/governify-csp-tools/releases/tag/0.0.1)