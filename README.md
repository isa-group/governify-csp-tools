...
The version 0.3.3 is the latest stable version of governify-csp-tools component.
see [release note](http://github.com/isa-group/governify-csp-tools/releases/tag/0.3.3) for details.

For running:

- Download latest version from [0.3.3](http://github.com/isa-group/governify-csp-tools/releases/tag/0.3.3)